            ...
            faqs.forEach((f, i) => {
                container.innerHTML += `
                    <div class="border border-gray-700/50 rounded-xl overflow-hidden">
                        <button 
                            onclick="toggleFaq(${i})"
                            class="w-full text-left px-6 py-4 bg-gray-800/60 hover:bg-gray-700/60 transition flex justify-between items-center gap-4"
                        >
